        ...
        <div className="w-4/5 bg-gray-50 overflow-hidden">
          <div className="h-full">
            <div className="h-full">
              ...
              >
                <PendingIV
                  pageState={pendingIVState}
                  setPageState={setPendingIVState}
                />
              </div>
              <div
                style={{
              ...
              >
                <AssignedIV
                  pageState={assignedIVState}
                  setPageState={setAssignedIVState}
                />
              </div>
              <div
                style={{
              ...
              >
                <ProductionIV
                  pageState={productionIVState}
                  setPageState={setProductionIVState}
                />
              </div>
              <div
                style={{

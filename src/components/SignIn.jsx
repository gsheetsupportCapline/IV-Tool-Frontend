    ...
    <div style={styles.body}>
      <div style={styles.container}>
        <img
          ...
          style={styles.logo}
        />
        <h2 style={styles.heading}><strong>Insurance Verification</strong></h2>
...
const styles = {
  body: {
    ...
    background: "url('https://drive.google.com/thumbnail?sz=w1920&id=1G7ma3e_QloYYOID3SHu6qded2452kJ4O') no-repeat center center fixed",
